...
# The LOF model is for spacetrack_starlink.json because it compares each satellite
...
# run by python3 local_outlier_factor/local_outlier_factor_spacetrack.py
...
# save output
anomalies_df.to_csv("local_outlier_factor/anomalies_lof_spacetrack.csv", index=False)

print("Done.")
print("Anomalies saved to anomalies_lof_spacetrack.csv")
...
# convert LOF score to circle size
...
plt.title("Local Outlier Factor (LOF) - SpaceTrack Starlink")
...
plt.tight_layout()
plt.savefig("local_outlier_factor/lof_spacetrack_plot.png", dpi=300)
plt.show()